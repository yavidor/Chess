function Knight(x,y,color){
  ...
  this.findMoves=function(){
    ...
    if (this.x-2>0){
      if(this.y+1<=8)
      if(grid[this.x-3][this.y].piece==null||grid[this.x-3][this.y].piece.color!=this.color)
      this.moves.push(grid[this.x-3][this.y]);
      if(this.y-1>0)
      if(grid[this.x-3][this.y-2].piece==null||grid[this.x-3][this.y-2].piece.color!=this.color)
    ...
    if (this.y-2>0){
      if(this.x+1<=8)
      if(grid[this.x][this.y-3].piece==null||grid[this.x][this.y-3].piece.color!=this.color)
      this.moves.push(grid[this.x][this.y-3]);
      if(this.x-1>0)
      if(grid[this.x-2][this.y-3].piece==null||grid[this.x-2][this.y-3].piece.color!=this.color)
